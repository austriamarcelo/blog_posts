...
class BlogPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blog_post" do
    assert_difference("BlogPost.count") do
      post blog_posts_url, params: { blog_post: { author_email: @blog_post.author_email, author_name: @blog_post.author_name, content: @blog_post.content, title: @blog_post.title } }
    end
  ...
  test "should update blog_post" do
    patch blog_post_url(@blog_post), params: { blog_post: { author_email: @blog_post.author_email, author_name: @blog_post.author_name, content: @blog_post.content, title: @blog_post.title } }
